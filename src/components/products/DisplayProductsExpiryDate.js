...
function DisplayProductsExpiryDate() {
  const { data, isLoading: isLoadingAll } = useGet(
    `${baseURL}products/expired`
  );
  ...
  return (
    <div>
      ...
      >
        <Paper elevation={3}>
          <Typography variant="h6">Display All Products Expired</Typography>
          <MaterialReactTable
...
export default DisplayProductsExpiryDate;
